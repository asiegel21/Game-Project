...
public class MouseLook : MonoBehaviour
{
    ...
    void LookAround()
    {
        ...
        lookAngles.x = Mathf.Clamp(lookAngles.x, defaultLookLimits.x, defaultLookLimits.y); //locks player view to certain parameters

        //currentRollAngle = Mathf.Lerp(currentRollAngle, Input.GetAxisRaw(MouseAxis.mouseX) * rollAngle, Time.deltaTime * rollSpeed); //adds dizzyness to camera
